...
***
Согласно [плану автоматизаци](https://github.com/AngelinaTest/diplom/blob/main/docs/Plan.md) тестирования комплексного сервиса покупки туров, реализованно 50 тест-кейсов.  Проведено предварительное ручное тестирование.
