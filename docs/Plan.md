...
## Предусловие выполнения сценария:
    1. Скачать проект с [Github]_(https://github.com/AngelinaTest/diplom) командой git clone
...
- Подготовка к проведению тестирования (запуск SUT, подготовка плана автоматизации) - 8 рабочих часов; ориентировочная дата сдачи 16.08.2025
-  Написание и прогон авто-тестов - 66 рабочих часов; ориентировочная дата сдачи 14.08.2025
-  Составление *Issue* - 8 рабочих часов; ориентировочная дата сдачи 16.08.2025
-  Оформление отчёта по итогам тестирования - 8 рабочих часов; 15.08.2025
-  Оформление отчёта по итогам автоматизации - 10 рабочих часов. 15.08.2025
